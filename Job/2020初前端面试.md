...
9. 操作系统的进程调度有哪些？
10. JS的执行流程是什么？事件队列是什么？Nodejs里的setTimeout、setInterval、setImmediate、nextTick有什么区别？
11. Nodejs的`fs.readFile()`和`fs.readFileSync()`有什么区别？怎么用前者模拟后者？
12. Nodejs的`stream`是干嘛的呢？
13. SSR了解过吗？
14. 简单问了下简历里的项目经验
